...
`172.55.0.4 site.dockerweb`

`172.55.0.6 mailhog.dockerweb`

`172.55.0.7 ngrok.dockerweb`

`172.55.0.9 phpmyadmin.dockerweb`


### Docker Toolbox
#### Windows
* Download and extract [Docker Compose web](https://github.com/a-kom/docker-compose-web/releases) into your user directory.
Like `C:\Users\UserName\docker-compose-web`.
* Launch Docker Quickstart Terminal.
* Go to the [docker-compose-web directory](/docs/screenshots/Docker-Quickstart-Terminal-web-directory.jpg): `cd /c/Users/UserName/docker-compose-web`.
...
* Navigate to a browser http://192.168.99.100/info.php and check that the NGINX container is available from the [browser](/docs/screenshots/Docker-Compose-web-check-in-browser.jpg).
...
`192.168.99.100 site.dockerweb`

##### Docker Toolbox Known Issues
* (MariaDB doesn't start) https://github.com/a-kom/docker-compose-web/issues/5
* (MariaDB is aborting always) https://github.com/a-kom/docker-compose-web/issues/4
